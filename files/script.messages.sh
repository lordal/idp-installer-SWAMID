...
slesCmd1="zypper -n -l install patch ntp unzip curl >> ${statusFile} 2>&1"
slesCmd2="zypper -n -l install git-core maven java-1_7_0-openjdk-headless >> ${statusFile} 2>&1"
slesCmd3="zypper -n -l install update-alternatives >> ${statusFile} 2>&1"
slesCmd4="zypper -n -l install tomcat >> ${statusFile} 2>&1"
slesCmd5="zypper -n -l install mysql >> ${statusFile} 2>&1"
